...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "博麗靈夢", "Set default nickname.")
	...
	//通过代码写死的方式添加主人账号
	sus = append(sus, 3284322148)
	sus = append(sus, 1446453465)
	sus = append(sus, 2209055918)
	sus = append(sus, 2319926703)
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "Block"),
